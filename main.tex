...
\begin{figure}
    ...
    \begin{subfigure}{\linearFigSze\textwidth}
          \centering
          \includegraphics[width=\columnwidth]{img/CH_byterate.png}
...
\begin{figure}
    ...
    \begin{subfigure}{\linearFigSze\textwidth}
          \centering
          \includegraphics[width=\columnwidth]{img/CH_flowrate.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{img/BCH2_CH_hourly_compare_fps.png}
...
\begin{figure}
    ...
    \begin{subfigure}{\linearFigSze\textwidth}
          \centering
          \includegraphics[width=\columnwidth]{img/CH_acaBus_bps.png}
          \caption{Data-rate during new year holidays}
...
\begin{figure}
    ...
    \begin{subfigure}{\linearFigSze\textwidth}
          \centering
          \includegraphics[width=\columnwidth]{img/CH_acaBus_fps.png}
          \caption{Flow-rate during new year holidays}
...
\begin{figure}
    ...
    \begin{subfigure}{\linearFigSze\textwidth}
          \centering
          \includegraphics[width=\columnwidth]{img/CO_byterate.png}
...
\begin{figure}
    ...
    \begin{subfigure}{\linearFigSze\textwidth}
          \centering
          \includegraphics[width=\columnwidth]{img/CO_flowrate.png}
...
\begin{figure}
    ...
    \begin{subfigure}{\linearFigSze\textwidth}
          \centering
          \includegraphics[width=\columnwidth]{img/CO_acaBus_bps.png}
          \caption{Data-rate during COVID-19 pandemic}
...
\begin{figure}
    ...
    \begin{subfigure}{\linearFigSze\textwidth}
          \centering
          \includegraphics[width=\columnwidth]{img/CO_acaBus_fps.png}
          \caption{Flow-rate during COVID-19 pandemic}
