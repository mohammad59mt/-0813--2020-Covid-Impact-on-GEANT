...
\begin{figure}[hbt!]
    ...
    \begin{subfigure}{\figSzeMahdi\columnwidth}
          ...
          \caption{Top 14 ASes generating traffic during working days}
          \label{fig:OWD_topAS_gen_bps}
    \end{subfigure}
    \begin{subfigure}{\figSzeMahdi\columnwidth}
          \centering
          \includegraphics[width=\columnwidth]{img/OWE_top14AS_generating_bps.png}
          \caption{Top 14 ASes generating traffic during weekends}
          \label{fig:OWE_topAS_gen_bps}
    \end{subfigure}
    \caption{Impact of weekends on top ASes generating data}
    \label{fig:topAS_gen_OWD_OWE}
\end{figure}
...
\begin{figure}[htb!]
    ...
    \begin{subfigure}{\figSzeMahdi\columnwidth}
          \centering
          \includegraphics[width=\columnwidth]{img/OWD_top14AS_generating_fps.png}
          \caption{Top 14 ASes generating flow during working days}
          \label{fig:OWD_topAS_gen_fps}
    \end{subfigure}
    \begin{subfigure}{\figSzeMahdi\columnwidth}
          \centering
          \includegraphics[width=\columnwidth]{img/OWE_top14AS_generating_fps.png}
          \caption{Top 14 ASes generating flow during weekends}
          \label{fig:OWE_topAS_gen_fps}
    \end{subfigure}
    \caption{Impact of weekends on top ASes generating flow}
    \label{fig:flowrate_topAS_gen_OWD_OWE}
\end{figure}
...
\begin{figure}[hbt!]
    ...
    \begin{subfigure}{\figSzeMahdi\columnwidth}
          \centering
          \includegraphics[width=\columnwidth]{img/OWD_top14AS_recieving_bps.png}
          \caption{Top 14 ASes receiving traffic during working days}
          \label{fig:OWD_topAS_rec_bps}
    \end{subfigure}
    \begin{subfigure}{\figSzeMahdi\columnwidth}
          \centering
          \includegraphics[width=\columnwidth]{img/OWE_top14AS_recieving_bps.png}
          \caption{Top 14 ASes receiving traffic during weekends}
          \label{fig:OWE_topAS_rec_bps}
    \end{subfigure}
    \caption{Impact of weekends on top ASes receiving data}
    \label{fig:topAS_rec_OWD_OWE}
\end{figure}
...
\begin{figure}[hbt!]
    ...
    \begin{subfigure}{\figSzeMahdi\columnwidth}
          \centering
          \includegraphics[width=\columnwidth]{img/OWD_top14AS_recieving_fps.png}
          \caption{Top 14 ASes receiving flow during working days}
          \label{fig:OWD_topAS_rec_fps}
    \end{subfigure}
    \begin{subfigure}{\figSzeMahdi\columnwidth}
          \centering
          \includegraphics[width=\columnwidth]{img/OWE_top14AS_recieving_fps.png}
          \caption{Top 14 ASes receiving flow during weekends}
          \label{fig:OWE_topAS_rec_fps}
    \end{subfigure}
    \caption{Impact of weekends on top ASes receiving flows}
    \label{fig:flowrate_topAS_rec_OWD_OWE}
\end{figure}
...
\begin{figure}[hbt!]
    ...
    \begin{subfigure}{\figSzeMahdi\columnwidth}
          ...
          \caption{Top 7 ASes generating traffic before new year holidays}
          \label{fig:BCH2_topAS_gen_bps}
    \end{subfigure}
    \begin{subfigure}{\figSzeMahdi\columnwidth}
          \centering
          \includegraphics[width=\columnwidth]{img/CH2_top14AS_generating_bps.png}
          \caption{Top 7 ASes generating traffic during new year holidays}
          \label{fig:CH2_topAS_gen_bps}
    \end{subfigure}
    \caption{Impact of new year holidays on top ASes data-rate}
...
\begin{figure}[hbt!]
    ...
    \end{subfigure}
    \caption{Impact of new year holidays on top ASes generating flow}
...
\begin{figure}[hbt!]
    ...
    \end{subfigure}
    \caption{Impact of new year holidays on top ASes receiving data}
...
\begin{figure}[hbt!]
    ...
    \end{subfigure}
    \caption{Impact of new year holidays on on top ASes receiving flow}
...
\begin{figure}
    ...
    \end{subfigure}
    \caption{Impact of COVID-19 pandemic on top ASes generating data}
...
\begin{figure}
    ...
    \end{subfigure}
    \caption{Impact of COVID-19 pandemic on top ASes generating flow}
...
\begin{figure}
    ...
    \end{subfigure}
    \caption{Impact of COVID-19 pandemic on top ASes receiving  data}
...
\begin{figure}
    ...
    \end{subfigure}
    \caption{Impact of COVID-19 pandemic on top ASes receiving flow}
